...
import {
  KYBParentKYCSessionExampleAdapter
} from "@/collection-flow/workflow-adapters/kyb_parent_kyc_session_example/kyb_parent_kyc_session_example.workflow-adapter";
