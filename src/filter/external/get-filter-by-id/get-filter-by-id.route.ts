...
import { GetFilterByIdRouteExternalSchema } from "@/filter/external/get-filter-by-id/get-filter-by-id.schema";
import { FilterRepository } from "@/filter/filter.repository";
import { db } from "@/db/client";
import { FilterService } from "@/filter/filter.service";

export const getFilterByIdRouteExternal: FastifyPluginAsyncTypebox = async (app) => {
  ...
  app.route({
    method: "GET",
    url: "/:id",
    schema: GetFilterByIdRouteExternalSchema,
