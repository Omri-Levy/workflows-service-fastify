import {ListWorkflowsByBusinessIdRouteExternalSchema} from './list-workflows-by-business-id.schema';
...
export const listWorkflowsByBusinessIdRouteExternal: FastifyPluginAsyncTypebox = async (app) => {
  ...
  app.route({
    method: "GET",
    url: "/:businessId/workflows",
    schema: ListWorkflowsByBusinessIdRouteExternalSchema,
