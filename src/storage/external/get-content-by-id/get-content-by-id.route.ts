...
import { GetContentByIdRouteExternalSchema } from "@/storage/external/get-content-by-id/get-content-by-id.schema";
...
export const getContentByIdExternalRoute: FastifyPluginAsyncTypebox = async (app) => {
  ...
  app.route({
    method: "GET",
    url: "/content/:id",
    schema: GetContentByIdRouteExternalSchema,
