import {
  GetRunnableWorkflowByIdRouteExternalSchema
} from "@/workflow/external/get-runnable-workflow-by-id/get-runnable-workflow-by-id.schema";
...
export const getRunnableWorkflowByIdRouteExternal: FastifyPluginAsyncTypebox = async (app) => {
  ...
  app.route({
    method: "GET",
    url: "/:id",
    schema: GetRunnableWorkflowByIdRouteExternalSchema,
