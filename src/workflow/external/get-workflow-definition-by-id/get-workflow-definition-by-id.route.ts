...
import {
  GetWorkflowDefinitionByIdRouteExternalSchema
} from "@/workflow/external/get-workflow-definition-by-id/get-workflow-definition-by-id.schema";
...
export const getWorkflowDefinitionByIdRouteExternal: FastifyPluginAsyncTypebox = async (app) => {
  ...
  app.route({
    ...
    schema: GetWorkflowDefinitionByIdRouteExternalSchema,
