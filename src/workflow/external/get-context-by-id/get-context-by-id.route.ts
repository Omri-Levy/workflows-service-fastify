...
import { GetContextByIdRouteExternalSchema } from "@/workflow/external/get-context-by-id/get-context-by-id.schema";
...
export const getContextByIdRouteExternal: FastifyPluginAsyncTypebox = async (app) => {
  ...
  app.route({
    method: "GET",
    url: "/:id/context",
    schema: GetContextByIdRouteExternalSchema,
