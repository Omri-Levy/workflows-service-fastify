...
import { SendEventRouteExternalSchema } from "@/workflow/external/send-event/send-event.schema";
...
export const sendEventRouteExternal: FastifyPluginAsyncTypebox = async (app) => {
  ...
  app.route({
    method: "POST",
    url: "/:id/send-event",
    schema: SendEventRouteExternalSchema,
