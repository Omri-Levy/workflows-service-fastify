...
import {
  UpdateWorkflowRuntimeDataByIdRouteExternalSchema
} from "@/workflow/external/update-workflow-runtime-data-by-id/update-workflow-runtime-data-by-id.schema";
...
export const updateWorkflowRuntimeDataByIdRouteExternal: FastifyPluginAsyncTypebox = async (app) => {
  ...
  app.route({
    method: "PATCH",
    url: "/:id",
    schema: UpdateWorkflowRuntimeDataByIdRouteExternalSchema,
