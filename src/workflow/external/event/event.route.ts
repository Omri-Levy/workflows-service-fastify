...
import { EventRouteExternalSchema } from "@/workflow/external/event/event.schema";
...
export const eventRouteExternal: FastifyPluginAsyncTypebox = async (app) => {
  ...
  app.route({
    method: "POST",
    url: "/:id/event",
    schema: EventRouteExternalSchema,
