...
import {
  UpdateWorkflowRuntimeDataRouteInternalSchema
} from "@/workflow/internal/update-workflow-runtime-data-by-id/update-workflow-runtime-data-by-id.schema";

export const updateWorkflowRuntimeDataRouteInternal: FastifyPluginAsyncTypebox = async (app) => {
  ...
  app.route({
    method: "PATCH",
    url: "/:id",
    schema: UpdateWorkflowRuntimeDataRouteInternalSchema,
