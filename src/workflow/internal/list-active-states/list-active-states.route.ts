...
import { ListActiveStatesRouteInternalSchema } from "@/workflow/internal/list-active-states/list-active-states.schema";
...
export const listActiveStatesRouteInternal: FastifyPluginAsyncTypebox = async (app) => {
  ...
  app.route({
    method: "GET",
    url: "/active-states",
    schema: ListActiveStatesRouteInternalSchema,
